classdef dktax
    ...
    methods (Static)
        ...
        function table2latex_se(tab,tab_se, fid)
            assert(not(isempty(tab.Properties.RowNames)), 'Only implemented with RowNames for the table');
        ...
        function print_outcomes(outcomes, mp, headerStr, fid, DOLATEX)
            ...
            dktax.print_outcomes_comparison({outcomes}, {mp}, headerStr, {headerStr}, fid, DOLATEX);
        end
        ...
        function print_outcomes_comparison(outcomes_cell, mp_cell, headerStr, names_cell, outputFileName, DOLATEX, DOSHORT)
            ...
            toPrint = { 'social_surplus_total', 'total_revenue',                  'revenue_fuel',                 'revenue_car',          'extern_vkt',                       'total_extern',             'consumer_surplus',                    'total_co2', 'total_vkt',  'Ecarage'   , 'nocar_share'     };
            labels  = { 'Social surplus (1000 DKK)', 'Total tax revenue (1000 DKK)',   'Fuel tax revenue (1000 DKK)', 'Car tax revenue (1000 DKK)','Non-CO2 externalities (1000 DKK)', 'Externalities (1000 DKK)', 'Consumer surplus (1000 DKK)', 'CO2 (ton)', 'VKT (1000 km)',      'E(car age)', 'Pr(no car)' };
