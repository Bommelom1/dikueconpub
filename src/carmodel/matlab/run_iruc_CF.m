...
% policy_outcome = 'consumer_surplus';  
policyvar='tax_fuel'; % the lever used to achieve equivalence 

% paths (leave empty to drop saving)
outputfile      = sprintf('results/iruc_CF/results_iruc_approximated_price_%s', policy_outcome);
figpath         = 'results/iruc_CF';
...
mp1.tax_fuel = bisection(policy_objective1, 0.5, 3.5, ftol); 
...
mp3.tax_fuel = bisection(policy_objective3, .5, 3.5, ftol);
